# Casos de teste — documentacao/padronizador-textos

Descricao: Use para aplicar padrão da casa (tom, vocabulário, formatação) a textos existentes sem alterar o conteúdo técnico.
