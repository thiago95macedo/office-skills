# Casos de teste — documentacao/organizador-documental

Descricao: Use para propor estrutura de pastas e nomenclatura para acervos de documentos (políticas, contratos, projetos).
