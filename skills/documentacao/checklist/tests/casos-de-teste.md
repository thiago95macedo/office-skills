# Casos de teste — documentacao/checklist

Descricao: Use para criar listas de verificação aplicáveis a rotinas críticas (auditoria, manutenção, onboarding, fechamento mensal).
