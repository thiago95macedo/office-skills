# Casos de teste — documentacao/manual-tecnico

Descricao: Use para produzir manuais técnicos completos (instalação, operação, manutenção) de equipamentos ou sistemas.
