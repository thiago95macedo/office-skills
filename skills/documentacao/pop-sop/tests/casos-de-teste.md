# Casos de teste — documentacao/pop-sop

Descricao: Use para criar POP (Procedimento Operacional Padrão) ou SOP auditável, com objetivo, escopo, responsabilidades, materiais, procedimento, registros.
