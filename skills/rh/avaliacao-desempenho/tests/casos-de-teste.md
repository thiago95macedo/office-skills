# Casos de teste — rh/avaliacao-desempenho

Descricao: Use para produzir roteiro completo de avaliação de desempenho (ciclo, critérios, evidências, calibração, PDI).
