# Casos de teste — produtividade/resumo-executivo

Descricao: Use para produzir resumo executivo de documento longo (relatório, ata, proposta, estudo) com foco em decisões e números.
