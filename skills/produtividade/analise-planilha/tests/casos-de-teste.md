# Casos de teste — produtividade/analise-planilha

Descricao: Use para analisar planilhas (CSV, Excel) e produzir descrição de dados, tendências, outliers e insights.
